...
#
# * $\ell=0,1,2,\dots$ is the degree, which controls its overall angular scale, or spatial frequency.
# * $m=-\ell,\dots,\ell$ is the order, which controls its variation with longitude.
#
...
# Spherical harmonics are usually complex-valued because of the factor $\exp(i m\phi)$.
#
...
# Use McEwen-Wiaux sampling with band-limit L = 32
sampling = "mw"
L = 32
